...
function SignupContent() {
    ...
    const handleNext = (e: React.FormEvent) => {
        ...
        if (step === 1) {
            ...
            if (age < 18) {
                setError("You must be at least 18 years old to join SoulLink.");
                setNovaMessage("Whoops! SoulLink is for souls 18 and older. Come back when you're a bit more... vintage. 😉");
                triggerShake();
                return;
            }
            setStep(2);
