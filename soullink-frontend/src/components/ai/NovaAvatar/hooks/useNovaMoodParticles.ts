...
export function useNovaMoodParticles({
    ...
    // Glitched state logic - Digital artifacts
    const [glitchBlocks, setGlitchBlocks] = useState<{ id: number; x: number; y: number; w: number; h: number; color: string }[]>([]);
