...
import { Settings2, Power, Brain, HelpCircle, Search, Zap, Heart, MousePointer2, Frown, Sparkles, Smile, Droplets, Flame, Ghost, Lock, Video, Coffee, Coins, Volume2, VolumeX } from "lucide-react";
...
export function NovaPanel() {
  ...
  const {
    ...
    isSingularity, setIsSingularity, isNuclearSingularity, setIsNuclearSingularity, triggerEatInput,
              ...
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
                ...
                <div>
                  ...
                  <div style={{ marginTop: 6, display: 'flex', gap: 6 }}>
                    ...
                    <button
                      className={`${styles.moodBtn} ${!isAudioMuted ? styles.active : ""} `}
                      onClick={() => setAudioMuted(!isAudioMuted)}
                      style={{ 
                        flex: 1, 
                        gap: 6,
                        borderColor: !isAudioMuted ? '#10b981' : undefined,
                        color: !isAudioMuted ? '#10b981' : undefined
                      }}
                      disabled={status === "offline"}
